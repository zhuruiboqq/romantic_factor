...
<article class="brand_story_article brand_story">
	...
	<div class="brand_right_content brand_story_right_content right">
		...
		<img src="images/brand_content_pic_1.jpg" />
		<h1>
			<!-- 緣起 -->
		</h1>
		<h2>
		...
		<img src="images/brand_content_pic_2.jpg" />
		<h1>
			<!-- 緣續 -->
		</h1>
		<h2>
		...
		<p>罗蔓缘素平台的集中服务在很大程度上改变了传统的到店或者在互联网上挨个寻找咨询的方式，也改变了人们的生活消费方式。不做冤大头、自由选择，遵循消费者最本质的需求。</p>
		<p>除了便捷地满足用户需求外，罗蔓缘素也为提供服务的个体及机构提供一个公平、高效的资源整合推广平台。使服务个体机构能轻松高效地获得婚礼市场的最新动态，更好地了解消费者的心理，各地同行之间相互学习提高，更好地发展自己适应市场的需求。</p>
		<img src="images/brand_content_pic_3.jpg" />
	</div>
</article>
